...
c.nome as nome_curso, i.nome as nome_intituicao, end_i.estado as estado_i, end_i.cidade as cidade_i');
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark text-white">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="navbar-nav">
                <a id="nav-first" class="nav-item nav-link text-light" href="dashboard.php">Início <span
                ...
                <div class="row cadastro">
                    <div class="corpo container-fluid p-4">
                        <div class="container-fluid bg-white border-20 p-4">
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                    <form method="POST" action="" name="cadastrarAluno" id="formulario"
                                    autocomplete="off">
                                        <div class="form-row">
                                    ...
                                    <div class="col-md-6" id="segunda-parte">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 row">
                                                <div class="form-group col-sm-8">
                                                    ...
                                                    <input required name="numero" minlength="1" maxlength="4"
                                        ...
                                        <button hidden id="cadastrar" type="submit"
                                            class="mt-4 btn btn-success float-right">Cadastrar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
$(document).ready(function($) {
    ...
    $(document).on('click', '#btnVisualizar', e => {
        ...
        let nome_intituicao = new String( valor.nome_intituicao + ' ('+valor.cidade_i+' - '+valor.estado_i+')')
        ...
        $('.modal').unbind('click').unbind('mousemove')
    });
